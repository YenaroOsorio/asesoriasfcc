        ...
        <div class="row wrapper">
            ...
            <div class="col-lg form-center d-flex justify-content-center align-items-center">
                <div class="container-form">
                    <h1 class="register-login-h1">Registro Alumno</h1>
                          ...
                          $password2 = md5($pass2);
                            ...
                            if($nombre==NULL|$apellidos==NULL|$matricula==NULL|$email==NULL|$password==NULL|$password2==NULL) 
                            {
                                ...
                                if($password!=$password2) {
                                    ...
                                    $checkemail = mysqli_query($link,"SELECT correo FROM alumnos WHERE correo='$email'");
                                    $email_exist = mysqli_num_rows($checkemail);
                                    
                                    $checkmat = mysqli_query($link,"SELECT matricula FROM alumnos WHERE matricula='$matricula'");
                                    ...
                                    if ($email_exist>0|$mat_exist>0) {
                                        ...
                                        $query = 'INSERT INTO alumnos (rol, matricula, nombre, apellidos, correo, password)
                                        VALUES (3,\''.$matricula.'\',\''.$nombre.'\',\''.$apellidos.'\',\''.$email.'\',\''.$password.'\')';
